...
from DeepRLAgent.SimpleCNNEncoder.larger_encoder import Encoder as larger_encoder
...
class Train(BaseTrain):
    def __init__(self,
        ...
        self.encoder = larger_encoder(n_classes, data_train.state_size).to(device)
        ...
        test_encoder = larger_encoder(n_classes, self.data_train.state_size).to(device)
